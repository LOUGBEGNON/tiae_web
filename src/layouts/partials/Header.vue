            ...
            <slot name="content-right">
              ...
              <div class="dropdown d-inline-block ms-2">
                ...
                >
                  ...
                  <div
                    class="p-3 text-center bg-body-light border-bottom rounded-top" v-else
                  >
                    <img
                      class="img-avatar img-avatar48 img-avatar-thumb"
                      src="/assets/media/avatars/avatar10.jpg"
                      alt="Header Avatar"
                    />
                    <p class="mt-2 mb-0 fw-medium">John Smitgbrgdgrhh</p>
                    <p class="mb-0 text-muted fs-sm fw-medium">Web Developer</p>
                  </div>
                  <div class="p-2">
                    <a
                    ...
                    >
                      <span class="fs-sm fw-medium">Mes messages</span>
